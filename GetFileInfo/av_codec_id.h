...
const std::map<AVCodecID, std::string> av_codec_id_map = {
    ...
    {AV_CODEC_ID_IFF_ILBM, "AV_CODEC_ID_IFF_ILBM (AV_CODEC_ID_IFF_BYTERUN1)"},
    ...
    {AV_CODEC_ID_HEVC, "AV_CODEC_ID_HEVC (AV_CODEC_ID_H265)"},
    ...
    {AV_CODEC_ID_DVD_SUBTITLE, "AV_CODEC_ID_DVD_SUBTITLE (AV_CODEC_ID_FIRST_SUBTITLE)"},
    ...
    {AV_CODEC_ID_TTF, "AV_CODEC_ID_TTF (AV_CODEC_ID_FIRST_UNKNOWN)"},
...
std::string get_id_str(AVCodecID id) {
    auto it = av_codec_id_map.find(id);
    if (it != av_codec_id_map.end()) {
        return it->second;
    }
    return std::string("");
}